      ...
      {status === "approved" ? (
        <div className="max-w-3xl text-center">
          ...
          <ul className="list-disc list-inside text-left mt-6 space-y-4 text-lg text-gray-300">
            ...
            <li>
              📋{" "}
              <span className="font-semibold">Prepare the required documents</span>, such as ID or proof of residence.
            </li>
            <li>
        ...
        <div className="max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-300">
            But don&apos;t worry, there are still many pets waiting for a loving home
            like yours! Here&apos;s what you can do:
          </p>
          <ul className="list-disc list-inside text-left mt-6 space-y-4 text-lg text-gray-300">
            <li>
              🐾{" "}
